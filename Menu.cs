...
namespace Ikanustik {
  ...
  internal class Menus {
    ...
    public static void ClashMenu(Player player, Entity entity) {
      ...
      Console.WriteLine($"{player.Active_Weapon.Weapon_Name} ({player.Active_Weapon.Weapon_Class}):\n");
      Console.WriteLine($"\t{player.Active_Weapon.Min_Damage}-{player.Active_Weapon.Max_Damage} Schaden\t\t{player.Active_Weapon.Weapon_Durability} Haltbarkeit");
    ...
    public static void BetweenFight(Player player, ref bool HelgaMet) {
      ...
      do {
        Console.Clear();
        Menus.Bar();
        Console.WriteLine($"Spieler: {player.Name}\n\n\tGold: {player.Gold}\tErfahrung: {player.Skill}\tAusgerüstet: {player.Active_Weapon.Weapon_Name} ({player.Active_Weapon.Weapon_Durability}/{player.Active_Weapon.Weapon_FullDurability})\n");
        if (HelgaMet == false) {
